setwd("~/OneDrive - University of Glasgow/Project/COAD/eQTL/eQTL_95")
...
cis_eQTL_95 <- read.csv('COAD_cis_eQTL_95.csv',sep = ',')
trans_eQTL_95 <- read.csv('COAD_trans_eQTL_95.csv',sep = ',')
...
write.table(cis_joined_entrez, file = 'COAD_cis_entrez_95.csv', sep = '\t')
write.table(cis_joined_symbol, file = 'COAD_cis_symbol_95.csv', sep = '\t')

write.table(trans_joined_entrez, file = 'COAD_trans_entrez_95.csv', sep = '\t')
write.table(trans_joined_symbol, file = 'COAD_trans_symbol_95.csv', sep = '\t')
